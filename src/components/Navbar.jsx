...
const Navbar = () => {
  ...
  return (
    <div className='bg-white p-4 h-16 sm:rounded-4xl   flex justify-between items-center shadow-sm manrope-light fixed top-0 left-0 right-0 sm:left-4 sm:right-4  z-50'>
      {/* Logo */}
